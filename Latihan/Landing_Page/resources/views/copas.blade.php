...
<body>
    ...
    <section class= "pt-[3rem] bg-white">
        <div class="grid grid-cols-2">
            <div class="relative"> 
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-3xl text-white text-center font-serif drop-shadow-lg mb-[14.5rem]">
                    Collections
                </h1>
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-7xl text-white text-center font-serif drop-shadow-lg mb-[9rem]">
                    New Arrivals
                </h1>
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-xl text-white text-center font-mono drop-shadow-lg mb-[2.5rem]">
                    DISCOVER MORE
                </h1>
                <a href="" class="absolute inset-0 flex flex-col items-center justify-end text-3xl text-white text-center font-serif drop-shadow-lg mb-[2.7rem] ml-[12rem]">
            ...
            <div class="relative">
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-3xl text-white text-center font-serif drop-shadow-lg mb-[15rem]">
                    Magazine
                </h1>
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-5xl text-white text-center font-serif drop-shadow-lg mb-[9rem]">
                ...
                <img loading="lazy" src="https://cdn.ferrari.com/cms/network/media/img/resize/67850164f148170011190279-ferrari-kc23-magazine-box-2025-gate-desk-2?" alt="" class="w-full h-screen object-cover">
            </div>
            <div class="relative">
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-3xl text-white text-center font-serif drop-shadow-lg mb-[13rem]">
                    Sports Cars
                </h1>
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-5xl text-white text-center font-serif drop-shadow-lg mb-[10rem]">
                    FERARRI F80
                </h1>
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-xl text-white text-center font-mono drop-shadow-lg mb-[2.5rem]">
                    DISCOVER MORE
                ...
                <img loading="lazy" src="https://cdn.ferrari.com/cms/network/media/img/resize/6729ee6bb6f3320011b982d9-ferrari-f80-box-gate-nov-24-desk?" alt="" class="w-full h-screen object-cover">
            </div>
            <div class="relative">
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-3xl text-white text-center font-serif drop-shadow-lg mb-[12rem]">
                    Ferrari Museums
                </h1>
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-5xl text-white text-center font-serif drop-shadow-lg mb-[9rem]">
                    ONE OF A KING
                ...
                <img loading="lazy" src="https://cdn.ferrari.com/cms/network/media/img/resize/65d4ad580eb72b0022e65549-ferrari-one-of-a-kind-gate-box-desk?" alt="" class="w-full h-screen object-cover">
            </div>
            <div class="relative">
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-3xl text-white text-center font-serif drop-shadow-lg mb-[12rem]">
                    Ferrari Approved
                </h1>
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-5xl text-white text-center font-serif font-bold drop-shadow-lg mb-[9rem]">
                    PRE-OWNED
                </h1>
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-xl text-white text-center font-mono drop-shadow-lg mb-[2.5rem]">
                    DISCOVER MORE
                ...
                <img loading="lazy" src="https://cdn.ferrari.com/cms/network/media/img/resize/65e085b11804e5015f6628a1-ferrari-auto-pre-owned-immagine-land?" alt="" class="w-full h-screen object-cover">
            </div>
            <div class="relative">
                <h1 class="absolute inset-0 flex flex-col items-center justify-end text-3xl text-white text-center font-serif drop-shadow-lg mb-[12rem]">
                    Sports Cars
                ...
                <img loading="lazy" src="https://cdn.ferrari.com/cms/network/media/img/resize/66e14a6cd362ab0010cf35b8-ferrari-past-models-f40-box-gate-09-11-24-desk?" alt="" class="w-full h-screen object-cover">
            </div>
        </div>
    </section>


    <section class="bg-zinc-800 relative h-[21rem] w-full flex justify-center items-center">
        <div class="text-center text-white mb-[2.5rem]">
            ...
            <button type="button" class="focus:outline-none text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:ring-red-300 font-medium text-sm px-[5.5rem] py-5 me-2 mt-8 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900 font-sans">SUBSCRIBE</button>
        </div>
    </section>
