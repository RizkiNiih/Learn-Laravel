        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-6">
                ...
                <nav class="hidden md:flex space-x-8">
                    <a href="#" class="text-gray-600 hover:text-gray-900 font-medium">Beranda</a>
                    <a href="#" class="text-gray-600 hover:text-gray-900 font-medium">Politik</a>
                    <a href="#" class="text-gray-600 hover:text-gray-900 font-medium">Ekonomi</a>
                    <a href="#" class="text-gray-600 hover:text-gray-900 font-medium">Olahraga</a>
                    <a href="#" class="text-gray-600 hover:text-gray-900 font-medium">Teknologi</a>
                </nav>
            </div>
        </div>
    </header>
