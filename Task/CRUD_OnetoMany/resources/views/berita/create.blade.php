    ...
    <body class="bg-gray-50 min-h-screen">
        ...
        <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="form-card bg-white rounded-xl shadow-lg overflow-hidden">
                <form class="p-8 space-y-6" action="{{ route('berita.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div>
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-400">
                            ...
                            <input type="file" class="mt-4 w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100" accept="image/*" id="foto" name="foto">
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-6">
                        ...
                        <a href="{{ route('berita.home') }}" class="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-800 font-semibold py-3 px-6 rounded-lg transition-all duration-200 text-center">Kembali</a>
                    </div>
                </form>
            </div>
        </main>
